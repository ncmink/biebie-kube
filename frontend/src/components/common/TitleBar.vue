...
<template>
  <header class="drag-region shrink-0 border-b border-line bg-surface-1">
    <div class="mx-auto flex h-12 w-full max-w-6xl items-center gap-4 px-9 max-[72rem]:pl-20">
